...
module.exports = [
    body("usernameOrMail").optional().trim().not().isEmpty().withMessage(`MISSING_EMAIL_PARAMETER`),
    body('usernameOrMail').optional().isString().trim().withMessage(`EMAIL_MUST_BE_A_STRING`),
